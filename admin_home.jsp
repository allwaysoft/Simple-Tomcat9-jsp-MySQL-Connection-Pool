 ...
 <%@include file="admin_header.jsp"%>
     ...
     <div class="check">
         ...
         <div style="height:100px; width:50%;">
             <br><br>
             <h1 style="color:darkgreen;">Welcome Admin!</h1>
         </div>
         </center>
     ...
     <div class="main">
       ...
       Connection con=DriverManager.getConnection("jdbc:mysql://localhost/dbblooddonor", "dbblooddonor", "dbblooddonor");
        ResultSet rs=null;
      ...
      out.println(" <tr style='font-size:20px;'><td> "+city+" &nbsp;</td><td>|&nbsp; "+bloodgrp+"  </td><td>| &nbsp; "+day+" "+month+" "+year+"</td> <td>&nbsp;&nbsp;&nbsp;&nbsp; <a href="+"admin_more_blood_request.jsp?bid="+id+""+"><u>More</u></a></td></tr>");
              }
                    }
                    catch(Exception e){
                        out.println(e);
