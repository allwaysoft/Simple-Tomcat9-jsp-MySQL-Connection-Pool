...
<center>
    <div style="width: 100%">
        <div class="left_div" style="float:left; margin-top:120px; width:40%; margin-right:20px;">
            </br>
        ...
        <div class="right_div">
            ...
            <form id="frm_register" method="post" action="Registration.jsp" name="frm_register">   
